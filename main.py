...
def parse_args(args=None):
    ...
    parser.add_argument('--seed', default=42, type=float, help='random seed. default: the truth of the universe: 42')
    ...
    parser.add_argument('--load_modåel_path', default='logs', type=str, help='trained model checkpoint path.')
    ...
    parser.add_argument('--Phi', default=0.5, type=float, help='critic regularion term.')
    parser.add_argument('--Critic_weight', default=1.0, type=float, help='actor-critc loss weight.')
...
def get_model_config(args, num_ent, num_rel):
    config = {
        ...
        'phi': args.Phi, # regular proportionality constant
        ...
        'critic_weight': args.Critic_weight, # actor-critic weight
