...
class Episode(nn.Module):
    ...
    # change according to policyMLP
    # Add all_critic_values
    def forward(self, query_entities, query_timestamps, query_relations):
        ...
        for t in range(self.path_length):
            ...
            loss, logits, action_id, critic_values = self.agent(
                prev_relations,
                current_entites,
                current_timestamps,
            ...
            all_critic_values.append(critic_values)
        ...
        # 「all_critic_values」: [batchsize, path_length+1]
        # 「all_loss, all_logits, all_actions_idx 」: [batchsize, path_length]
        return all_loss, all_logits, all_actions_idx, all_critic_values, current_entites, current_timestamps
